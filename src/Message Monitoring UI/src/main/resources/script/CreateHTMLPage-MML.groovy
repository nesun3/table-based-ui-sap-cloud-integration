...
//                link(rel: "stylesheet", type: "text/css", href: "https://cdn.datatables.net/1.13.6/css/jquery.dataTables.min.css")
            ...
            body {
                ...
                \$(document).ready(function() {
                     document.title = "Message Processing Logs " + new Date().toISOString().slice(0, 19).replaceAll(':','');
                    \$('#example').DataTable( { 
                        dom: 'Bifrtlp',
                        fixedHeader: true,
                        fixedColumns:{
        ...
        message.setBody("No Message Processing Logs in the selected time period $formattedFromDate UTC to $formattedToDate UTC")
